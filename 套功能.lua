...
function switchTab(new)
	...
	if old == nil then
		...
		game:GetService("TweenService"):Create(new[1], TweenInfo.new(0.1), { ImageTransparency = 0 }):Play()
		game:GetService("TweenService"):Create(new[1].TabText, TweenInfo.new(0.1), { TextTransparency = 0 }):Play()
		return
	end
	if old[1] == new[1] then
		return
	...
	switchingTabs = true
	library.currentTab = new
	game:GetService("TweenService"):Create(old[1], TweenInfo.new(0.1), { ImageTransparency = 0.2 }):Play()
	game:GetService("TweenService"):Create(new[1], TweenInfo.new(0.1), { ImageTransparency = 0 }):Play()
	game:GetService("TweenService"):Create(old[1].TabText, TweenInfo.new(0.1), { TextTransparency = 0.2 }):Play()
	game:GetService("TweenService"):Create(new[1].TabText, TweenInfo.new(0.1), { TextTransparency = 0 }):Play()
	old[2].Visible = false
	new[2].Visible = true
	task.wait(0.1)
...
function library.new(library, name, theme)
	for _, v in next, game:GetService("CoreGui"):GetChildren() do
		if v.Name == "Ware Blue -- Make 123fa98" then
			v:Destroy()
		end
	end
	...
	dogent.Name = "Ware Blue -- Make 123fa98"
	dogent.Parent = game:GetService("CoreGui")
	...
	local tween = TweenService:Create(UIGradient, tweeninfo, { Rotation = 360 }):Play()
	function toggleui()
		toggled = not toggled
		spawn(function()
			if toggled then
		...
		function tab.section(tab, name, TabVal)
				...
				local funcs = {
					SetState = function(self, state)
						...
						game:GetService("TweenService"):Create(ToggleSwitch, TweenInfo.new(0.2), {
								Position = UDim2.new(0, (state and 0 or ToggleSwitch.Size.X.Offset / 2), 0, 0),
			...
			function section.Keybind(section, text, default, callback)
				...
				KeybindValue.MouseButton1Click:Connect(function()
					KeybindValue.Text = "..."
					wait()
					local key, uwu = game:GetService("UserInputService").InputEnded:Wait()
